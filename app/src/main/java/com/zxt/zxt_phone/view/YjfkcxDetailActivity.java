...
public class YjfkcxDetailActivity extends BaseActivity {

    private String TAG = YjfkcxDetailActivity.class.getCanonicalName();


    TextView btn1, btn2, title, noText;
    ImageView backBtn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yjfkcx_detail);
