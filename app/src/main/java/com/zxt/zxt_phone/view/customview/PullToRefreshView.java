...
public class PullToRefreshView extends LinearLayout {
	...
	private void addFooterView() {
        ...
        mFooterView = new RefreshFooter(mContext);
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if (newTopMargin >= 0 && mHeaderView.getState() != RefreshHeader.STATE_REFRESHING) {
		    //提示松开刷新
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight) && mFooterView.getState()  != RefreshFooter.STATE_LOADING) {
	...
	public void onHeaderRefreshFinish() {
		...
		if(mAdapterView!=null){
			...
			if(mCount > 0){
				...
				mFooterView.setState(RefreshFooter.STATE_EMPTY);
			}
		}else{
			mFooterView.setState(RefreshFooter.STATE_READY);
		}
	...
	public void onFooterLoadFinish() {
		...
		if(mAdapterView!=null){
			...
			if(countNew > mCount){
				...
				mFooterView.setState(RefreshFooter.STATE_NO);
			}
		}else{
			mFooterView.setState(RefreshFooter.STATE_READY);
		}
