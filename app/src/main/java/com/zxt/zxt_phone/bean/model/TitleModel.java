...
public class TitleModel {
    ...
    public List<DataNewsTitleModel> getData() {
        return Data;
    }

    public void setData(List<DataNewsTitleModel> Data) {
        this.Data = Data;
    }

    public static class DataNewsTitleModel {
        /**
         * Deptid : 2
         * DeptName : 社区
         * deptbh : 00.02
